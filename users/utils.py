class AppUserChoices:
    ...
    class GarbanzoUserChoices:
        TIPO = [
            ...
            ('moderador', 'Moderador'),  # Tem acesso aos dados de todos, se as Permissões concederem
            ('app_admin', 'Administrador da aplicação'),  # Tem acesso irrestrito, mas não altera itens do Server Admin
