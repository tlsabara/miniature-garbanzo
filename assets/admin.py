...
from assets.models import GarbanzoAssetType, GarbanzoAssetItem, GarbanzoLinkType, GarbanzoAssetClass
...
class CustomGarbanzoAssetAdmin(CustomAssetHistoryAdmin):
    ...
    history_readonly_fields = ('id', 'name_item', 'serial_number', 'tag_number', 'asset_number', 'type_asset',)

    readonly_fields = ('id',)
    list_display = ('name_item', 'serial_number', 'asset_number', 'tag_number', 'type_asset',)
    fieldsets = (
        (None, {'fields': ('name_item', 'serial_number', 'tag_number', 'type_asset', 'asset_number')}),
    )
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('name_item', 'email', 'asset_number', 'tag_number', 'type_asset', 'custom_fields')}
         ),
    )
