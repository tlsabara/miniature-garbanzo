    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_permissions', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('cpf_guser', models.CharField(max_length=11, validators=[users.validators.main.validador_cpf])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_guser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_gperms', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='users.garbanzoperms')),
                ('id_guser', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('system_create_at', models.DateTimeField(auto_now_add=True)),
                ('system_edited_at', models.DateTimeField(auto_now=True)),
                ('id_gperms', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.garbanzoperms')),
                ('id_guser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
