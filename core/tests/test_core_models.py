...
@pytest.mark.django_db
def test_extra_field_type_without_field_fixedvalues(fxt_create_garbanzoassettype, fxt_new_extra_field_type) -> None:
...
@pytest.mark.django_db
def test_extra_field_model(fxt_create_garbanzoassetitem,fxt_create_extrafieldtype, fxt_new_extra_field) -> None:
    ...
    assert str(extra_field) == f"{str(fxt_create_extrafieldtype)} on ASSET: {fxt_create_garbanzoassetitem.asset_number}"
